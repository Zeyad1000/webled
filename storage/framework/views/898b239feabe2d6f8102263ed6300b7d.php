                        ...
                        <div class="space-y-3">
                            ...
                            <div class="space-y-0.5">
                                <p class="mb-1 text-md text-black">
                                    phone : <?php echo e($post->phone); ?>

                                </p>
                                <p class="mb-1 text-md text-black">
                                    email : <?php echo e($post->email); ?>
...
<?php echo $__env->make('layouts.head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravelsProjects\final-web-led\resources\views/pages/admins/contact/view.blade.php ENDPATH**/ ?>