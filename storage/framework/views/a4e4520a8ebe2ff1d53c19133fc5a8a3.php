...
<body>
    ...
    <!-- Hero -->
    <div class="relative bg-gradient-to-bl from-teal-100 via-transparent">
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            <!-- Grid -->
            <div class="grid items-center md:grid-cols-2 gap-8 lg:gap-12">
                <div>
                    <p
                        class="inline-block text-sm font-medium bg-clip-text bg-gradient-to-l from-teal-600 to-teal-500 text-transparent">
                        اطلب خدمتك الان
                    </p>
                    ...
                    <div class="mt-4 md:mb-12 max-w-2xl">
                        <h1 class="mb-4 font-semibold text-gray-800 text-4xl lg:text-5xl">
                            خصص خدمتك واحصل علي افضل عرض سعر في الوطن العربي
                        </h1>
                        <p class="text-gray-600">
                            احصل علي افضل سعر في العالم ودم كبير جدا
                        </p>
                    </div>
                    <!-- End Title -->
                    ...
                    <blockquote class="hidden md:block relative max-w-sm">
                        <svg class="absolute top-0 start-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-200"
                        ...
                        <div class="relative z-10">
                            <p class="text-xl italic text-gray-800">
                                احد افضل الشراكات الي هتعمل الشغل علي اعلي مستوي اشرحهم وبشدة
                            </p>
                        </div>
                            ...
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <img class="h-8 w-8 rounded-full"
                                        src="https://mgmt.manhom.com/images/570267/%D8%BA%D8%B3%D8%A7%D9%86-%D8%A7%D9%84%D9%87%D8%A7%D8%B4%D9%85%D9%8A.webp"
                                        alt="Image Description">
                                </div>
                                <div class="grow ms-4">
                                    <div class="font-semibold text-gray-800">غسان الهاشمي</div>
                                    <div class="text-xs text-gray-500">Founder Muthaber</div>
                                </div>
                            </div>
                        </footer>
                    </blockquote>
                        ...
                        <div class="lg:max-w-lg lg:mx-auto lg:me-0 ms-auto">
                            ...
                            <div class="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-lg">
                                <div class="text-center">
                                    <h1 class="block text-2xl font-bold text-gray-800">اطلب خدمتك الان
                                    </h1>
                                </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                <input type="text" name="name"
                                                    ...
                                                    class="peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent focus:border-teal-500 focus:ring-teal-500 disabled:opacity-50 disabled:pointer-events-none
                                                                        focus:pt-6
                                                                        focus:pb-2
                                                ...
                                                <label for="hs-hero-signup-form-floating-input-first-name"
                                                    class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent peer-disabled:opacity-50 peer-disabled:pointer-events-none
                                                                        peer-focus:text-xs
                                                                        peer-focus:-translate-y-1.5
                                                                         peer-focus:text-gray-500
                                                                        peer-[:not(:placeholder-shown)]:text-xs
                                                                        peer-[:not(:placeholder-shown)]:-translate-y-1.5
                                                                         peer-[:not(:placeholder-shown)]:text-gray-500">اسم
                                                    العميل</label>
                                            </div>
                                            <!-- End Floating Input -->
                                        </div>
                                            ...
                                            <div class="relative">
                                                ...
                                                <label for="hs-hero-signup-form-floating-input-last-name"
                                                    class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent peer-disabled:opacity-50 peer-disabled:pointer-events-none
                                                                         ...
                                                                         peer-[:not(:placeholder-shown)]:text-xs
                                                                         peer-[:not(:placeholder-shown)]:-translate-y-1.5
                                                                         peer-[:not(:placeholder-shown)]:text-gray-500">رقم
                                                    الهاتف</label>
                                            </div>
                                            <!-- End Floating Input -->
                                        </div>
                                            ...
                                            <div class="relative">
                                                ...
                                                <label for="hs-hero-signup-form-floating-input-email"
                                                    class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent peer-disabled:opacity-50 peer-disabled:pointer-events-none
                                                                          ...
                                                                          peer-[:not(:placeholder-shown)]:text-xs
                                                                          peer-[:not(:placeholder-shown)]:-translate-y-1.5
                                                                         peer-[:not(:placeholder-shown)]:text-gray-500">الايميل</label>
                                            </div>
                                            <!-- End Floating Input -->
                                        </div>
                                        <!-- End Input Group -->
                                                ...
                                                <select name="stats" id="cars"
                                                    class="peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent focus:border-teal-500 focus:ring-teal-500 disabled:opacity-50 disabled:pointer-events-none
                                                       ...
                                                       focus:pb-2
                                                        ...
                                                        autofill:pt-6
                                                        autofill:pb-2">
                                                    <option value="تصميم صفحة هبوط UI & UX">تصميم صفحة هبوط UI & UX
                                                    </option>
                                                    <option value="تصميم موقع كامل UI & UX">تصميم موقع كامل UI & UX
                                                    </option>
                                                    <option value="برمجة صفحة هبوط ">برمجة صفحة هبوط </option>
                                                    <option value="برمجة موقع كامل">برمجة موقع كامل</option>
                                                    <option value="برمجة منصة تعليمية">برمجة منصة تعليمية</option>
                                                    <option value="برمجة نظام ERP">برمجة نظام ERP</option>
                                                    <option value="برمجة تطبيق Android">برمجة تطبيق Android</option>
                                                    <option value="برمجة تطبيق IOS">برمجة تطبيق IOS</option>
                                                    <option value="تصميم لوجو">تصميم لوجو</option>
                                                    <option value="تصميم ميديا">تصميم ميديا</option>
                                                    <option value="تصميم هوية بصرية">تصميم هوية بصرية</option>
                                                    <option value="باكج 10 ساعات تصوير">باكج 10 ساعات تصوير</option>
                                                    <option value="باكج 15 ساعة تصوير">باكج 15 ساعة تصوير</option>
                                                    <option value="باكج 25 ساعة تصوير">باكج 25 ساعة تصوير</option>
                                                    <option value="باكج 50 ساعة تصوير">باكج 50 ساعة تصوير</option>
                                                    <option value="اعلانات facebook">اعلانات facebook</option>
                                                    <option value="اعلانات instgram">اعلانات instgram</option>
                                                    <option value="اعلانات snapchat">اعلانات snapchat</option>
                                                    <option value="اعلانات tiktok">اعلانات tiktok</option>
                                                    <option value="اعلانات google">اعلانات google</option>
                                                </select>
                                            </div>
                                            <!-- End Floating Input -->
                            ...
                            autofill:pb-2"
                              ...
                              peer-[:not(:placeholder-shown)]:text-gray-500">العنوان</label>
                                    ...
                                    <div class="mt-5">
                                        <button type="submit"
                                            class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-teal-600 text-white hover:bg-teal-700 disabled:opacity-50 disabled:pointer-events-none">اطلب
                                            خدمتك الان</button>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- Clients Section -->
            <div
                class="mt-6 md:mt-12 py-3 flex items-center text-sm text-gray-800 gap-x-1.5 after:flex-[1_1_0%] after:border-t after:border-gray-200 after:ms-6">
                <span
                    class="font-semibold bg-clip-text bg-gradient-to-l from-teal-600 to-teal-500 text-transparent">50,000</span>
            ...
            <div class="flex flex-wrap gap-x-6 sm:gap-x-12 lg:gap-x-24">
                ...
                <svg class="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 text-gray-500" xmlns="http://www.w3.org/2000/svg"
                ...
                <svg class="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 text-gray-500" xmlns="http://www.w3.org/2000/svg"
                    x="0" y="0" viewBox="0 0 88 22" xml:space="preserve" enable-background="new 0 0 88 22">
                    <path
                ...
                <svg class="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 text-gray-500" xmlns="http://www.w3.org/2000/svg"
                    width="2500" height="1036" viewBox="0 -6.166 294.398 121.975">
                    <path
...
<?php echo $__env->make('layouts.head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravelsProjects\final-web-led\resources\views/pages/admins/invoicess/create.blade.php ENDPATH**/ ?>