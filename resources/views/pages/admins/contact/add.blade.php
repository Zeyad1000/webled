                        ...
                        <div class="lg:max-w-lg lg:mx-auto lg:me-0 ms-auto">
                            ...
                            <div class="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-lg">
                                ...
                                <div class="mt-5">
                                            ...
                                            <div class="relative">
                                                ...
                                                <label for="hs-hero-signup-form-floating-input-company-name"
                                                    class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent peer-disabled:opacity-50 peer-disabled:pointer-events-none
                                                                      ...
                                                                      peer-[:not(:placeholder-shown)]:text-xs
                                                                      peer-[:not(:placeholder-shown)]:-translate-y-1.5
                                                                     peer-[:not(:placeholder-shown)]:text-gray-500">الرسالة</label>
                                            </div>
                                            <!-- End Floating Input -->
                                        </div>
                                    ...
                                    <div class="mt-5">
                                        <button type="submit"
                                            class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-teal-600 text-white hover:bg-teal-700 disabled:opacity-50 disabled:pointer-events-none">قدم اقتراحك</button>
                                    </div>
                                </div>
                            </div>
                            <!-- End Card -->
